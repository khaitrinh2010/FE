...
const SignUp = () => {
    return(
        <div className="bg-gray-900 flex flex-col justify-center items-center h-screen space-y-4">
            ...
            <div className="space-y-4">
                ...
                <p>
                    Already have an account? Click <span className="underline">here</span> to login
                </p>
            </div>
